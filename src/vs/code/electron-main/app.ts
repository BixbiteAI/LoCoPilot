...
/**
 * The main LoCoPilot application. There will only ever be one instance,
...
export class CodeApplication extends Disposable {
	...
	async startup(): Promise<void> {
		this.logService.debug('Starting LoCoPilot');
		...
		// "com.microsoft.", which breaks native tabs for LoCoPilot when using this
	...
	private initChannels(accessor: ServicesAccessor, mainProcessElectronServer: ElectronIPCServer, sharedProcessClient: Promise<MessagePortClient>): void {
		...
		// Request (main process - avoids CORS in renderer)
